import pyttsx3
pyttsx3.speak("welcome to Inventory management system made by ayush bajpai")
unit_price={}
description={}
stock={}
...
print()
pyttsx3.speak("press A for Add an item")
pyttsx3.speak("press R for Remove an item")
pyttsx3.speak("press E for Edit specifics of an item")
pyttsx3.speak("press L for List all items")
pyttsx3.speak("press I for Inquire about a part")
pyttsx3.speak("press P for Purchase")
pyttsx3.speak("press C for Checkout")
pyttsx3.speak("press S for Show all parts purchased")
pyttsx3.speak("press Q for Quit")
pyttsx3.speak("press remove for Remove an item from the cart")
pyttsx3.speak("press help for all commands again")
print()
print("A-Add an item")
...
print()
pyttsx3.speak("Thank you for using IMS")
